...
public class MyBatisHelper {
    ...
    static {
        try {
            InputStream inputStream = Resources.getResourceAsStream("test/pkg/db/MyBatisHelper.xml");
            sqlSessionFactory = new SqlSessionFactoryBuilder().build(inputStream);
        } catch (Throwable e) {
            log.error("Exception during SQL map building: ", e);
        }
    }
     ...
     *
     * @param <E>       the returned list test.pkg.soapfile.bir.element type
     * @param statement Unique identifier matching the statement to use.
